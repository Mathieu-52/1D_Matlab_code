function [ k_step ] = c1_rk_step( c1, c2, phi, S, srf, nx, u, dt, dx, D1, D2, my_eps, A, k_rat, dirichlet, neumann, pf, D, r_a1, r_a2, r_d1, r_d2, s_inf)
nx=nx-1;
%S=zeros(nx,1);
k_step = zeros(nx,1);
...
J_s1=Delta_s.*-(r_a1*c1_tilde.*(s_inf-srf_tilde)-r_d1*srf_tilde);
